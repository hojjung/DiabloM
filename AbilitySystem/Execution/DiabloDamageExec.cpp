                                               ...
                                               OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	PRINTF("TookDmg1:%f", LTookPhysDamage);
	...
	//
	LTookPhysDamage *= LDamagePer;
	LTookFireDamage *= LDamagePer;
	...
	if (LTookPhysDamage > 0.f && LLifeSteal > 0.f)
	{
		...
		SourceAbilitySystemComponent->ApplyGameplayEffectSpecToTarget(*EffectSpecHandle.Data,
