...
{
	static ConstructorHelpers::FObjectFinder<UDataTable> FoundBaseTable(TEXT("DataTable'/Game/DataTables/MonsterTable.MonsterTable'"));
	if (FoundBaseTable.Succeeded())
	{
		m_MonsterUnitTable = FoundBaseTable.Object;
	}
	//
	static ConstructorHelpers::FObjectFinder<UDataTable> FoundBaseTable2(TEXT("DataTable'/Game/DataTables/NPCTable.NPCTable'"));
	if (FoundBaseTable2.Succeeded())
	{
		m_NPCUnitTable = FoundBaseTable2.Object;
	}
	static ConstructorHelpers::FObjectFinder<UDataTable> FoundBaseTable3(TEXT("DataTable'/Game/DataTables/PlayerTable.PlayerTable'"));
