...
#include "MyInAppPurchase.generated.h"

/**
 * 
 */
UCLASS()
class DIABLOM_API UMyInAppPurchase : public UObject
{
	GENERATED_BODY()
public:
	UMyInAppPurchase(const FObjectInitializer& ObjectInitializer);

	DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FInAppPurchaseResult, EInAppPurchaseState::Type, CompletionStatus,
	...
	static UMyInAppPurchase* CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController,
